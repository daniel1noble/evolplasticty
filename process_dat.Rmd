...
This loads the packages if necessary
```{r, message=FALSE, warning = FALSE}
source("R/packages.R")
```
 Read data from a supplemental materil of a meta-analysis.
```{r}
...
```
 ...
 Looks ok as authors got the core data from other authors.
